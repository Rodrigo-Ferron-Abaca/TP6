...
DefaultTableModel modelo;
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/lupita.png"))); // NOI18N
    ...
    //valida y filtra la tabla por precios 
    ...
    //valida y filtra la tabla por precios :b    
    ...
    private void llenarTabla(Double desde, Double hasta){
        if (desde.equals(0.0)&&hasta.equals(0.0)) {
            ...
            modelo.addRow(new Object[]{ prod.getCodigo(),prod.getDescripcion(),prod.getRubro(),prod.getStock(),prod.getPrecio()});
            }
        }
        else{
